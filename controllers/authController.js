...
// //     // Ensure BACKEND_URL is set in Render environment variables
// //     const BACKEND_URL = process.env.BACKEND_URL;
// //     if (!BACKEND_URL) {
// //       return res.status(500).json({ message: 'Server misconfiguration: BACKEND_URL missing.' });
// //     }

// //     // Map uploaded files to full public URLs
...
// //       donorAddress,
// //       donorId: req.user._id,
// //       images: imagePaths, // full URLs stored
// //     });
